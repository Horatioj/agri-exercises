...
authoritative cropland ag-county list, per the agreed rules:
  ...
  5   COMBINE rename pairs (_county_corrections.RENAME_COMBINE): 通什市+五指山市, ...
...
Run:  python src/01_resolve_roster.py
"""
...
# also honour the _county_corrections.REMOVE list (duplicate codes / unusable units)
for _c in CC.REMOVE:
