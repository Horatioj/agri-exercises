...
(Labour, Land, Capital, Intermediate), single output real_gvp:
  ...
  (A) FE Solow residual  -- same as 04_validate_tfp_io.py Panel C: two-way
      (county+year) FE Cobb-Douglas elasticities, ln TFP = lnY - Σβ lnX, national
      mean by year.
  (B) DEA TFP            -- output-oriented, NIRS (Σλ<=1), free-disposal inputs,
      SEQUENTIAL (non-regressive) frontier = all obs up to year t  (settings from
      dea_decomposition.py, no decomposition). Sequential Malmquist, cumulative.
